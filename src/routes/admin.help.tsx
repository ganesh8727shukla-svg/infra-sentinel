    ...
    <>
      ...
      <div className="grid gap-5 lg:grid-cols-2">
            ...
            <Card className="p-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm text-muted-foreground">
                    Review infrastructure risk levels and
                    system-generated alerts requiring
            ...
            <Card className="p-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm text-muted-foreground">
                    Review system decisions, user actions and
          ...
          <Card className="p-5">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-muted-foreground">
                  For access, data or platform issues, contact
                  your designated InfraSetu system administrator.
                </p>
        ...
        <Section
          ...
          description="Important principles for administering InfraSetu."
        >
          <Card className="p-5">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="mt-1 text-sm leading-6 text-muted-foreground">
                  Use recorded complaints, AI analysis, asset
                  information, risk scores and work-order records
                  when reviewing infrastructure decisions.
                </p>

                <p className="mt-3 text-sm leading-6 text-muted-foreground">
                  Automated and human decisions are recorded in
                  the Audit Trail to support transparency and
                  accountability across the infrastructure lifecycle.
                </p>
